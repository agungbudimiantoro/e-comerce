                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block">
                                <img src="../assets/images/login.jpg" alt="" width="450" height="500">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        if (isset($_GET['pesan'])) {
                                            ...
                                            if ($_GET['pesan'] == "akun") {
                                                echo "Akun anda tidak aktif, silakan hubungi Admin!";
                                            }
                                        } else {
                                    ...
                                    <form class="user" action="validasi_login.php" method="post">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                <input type="checkbox" class="custom-control-input" id="customCheck" name="setcookies">
